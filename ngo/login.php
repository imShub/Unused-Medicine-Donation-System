<?php include '../php/ngo_login_form_handeler.php';
?>
...
<head>
    ...
    <title> NGO Login | Unused Medicine Donation System</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="d-flex">
                            <a href="register.php" class="btn btn-outline-danger m-2"><i class="fa fa-user-plus"></i> Register</a>
                        </li>
                        <li class="d-flex">
                    ...
                    <div class="card card-registration my-2 w-50 mx-auto">
                        <div class="row g-0">
                            ...
                            <div class="card-body p-md-5 text-black">
                                <h2 class="mb-4 ms-3 fw-bolder heading">NGO Log In</h2>
