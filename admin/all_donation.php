...
<head>
    ...
    <title>All Donations | Unused Medicine Donation System</title>
...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="all_donation.php">All Donations</a>
                            </li>
                            <li class="nav-item">
    ...
    <main>
        ...
        <div class="container h-100" style="height: 100vh;">
            <h1 class="mx-auto heading">All Donations</h1>
